...
const STRIPE_PRICE_ID = 'price_REMPLACE_PAR_TON_NOUVEAU_PRICE_ID'
...
export default function LandingClient() {
  ...
  return (
    <div style={{ background: '#080810', color: '#e8e8f0', overflowX: 'hidden' }}>
      ...
      {/* ── NAV — sans bouton, juste la marque ── */}
      <nav style={{
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '780px' }}>
          ...
          {/* ── CTA UNIQUE — seul bouton de toute la page avec le footer ── */}
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', animation: 'slideUp 0.6s ease 0.4s both' }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px', marginBottom: '4px' }}>
              ...
              <span style={{ fontSize: '22px', color: 'rgba(255,255,255,0.3)', textDecoration: 'line-through' }}>394€</span>
              <span style={{ fontSize: '12px', fontWeight: 700, color: '#fbbf24', background: 'rgba(251,191,36,0.1)', padding: '3px 10px', borderRadius: '100px', border: '1px solid rgba(251,191,36,0.3)' }}>-83%</span>
            </div>
            <button
              onClick={handleCheckout}
              style={{
                padding: '16px 40px', borderRadius: '100px', border: 'none', cursor: 'pointer',
      ...
      {/* ── OFFER — texte simple, pas de carte surchargée ── */}
      <section id="acheter" style={{ padding: '7rem 2rem', maxWidth: '780px', margin: '0 auto' }}>
        <AnimatedSection>
          ...
          <h2 style={{ fontSize: 'clamp(28px,4vw,46px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '2rem' }}>
        ...
        <AnimatedSection>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '3rem' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '10px', fontSize: '15px' }}>
          ...
          <div style={{ padding: '1.5rem 2rem', borderRadius: '12px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', lineHeight: 1.6, margin: 0 }}>
                Tu appliques la méthode. Si tes résultats ne s'améliorent pas, tu m'envoies un email et je te rembourse intégralement.
              </p>
            </div>
          </div>
        </AnimatedSection>
      ...
      {/* ── FINAL CTA — seul deuxième bouton de la page ── */}
      <section style={{ padding: '8rem 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <AnimatedSection>
            ...
            <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.45)', marginBottom: '1rem' }}>
              Chaque jour sans campagne, tu paies le prix fort.
            </p>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px', justifyContent: 'center', marginBottom: '2rem' }}>
              <span style={{ fontSize: '32px', fontWeight: 800, color: '#fff' }}>67€</span>
              <span style={{ fontSize: '18px', color: 'rgba(255,255,255,0.3)', textDecoration: 'line-through' }}>394€</span>
              <span style={{ fontSize: '12px', fontWeight: 700, color: '#fbbf24', background: 'rgba(251,191,36,0.1)', padding: '3px 10px', borderRadius: '100px', border: '1px solid rgba(251,191,36,0.3)' }}>-83%</span>
            </div>
            <button
              onClick={handleCheckout}
