...
const titleShadow = '0 0 40px rgba(124,58,237,0.5), 0 0 80px rgba(124,58,237,0.2), 0 2px 20px rgba(0,0,0,0.8)'
const subtitleShadow = '0 0 30px rgba(96,165,250,0.35), 0 2px 12px rgba(0,0,0,0.7)'
const sectionTitleShadow = '0 0 24px rgba(124,58,237,0.4), 0 2px 10px rgba(0,0,0,0.6)'

const glossyBtn: React.CSSProperties = {
  padding: '16px 40px',
  borderRadius: '12px',
  border: '1px solid rgba(167,139,250,0.5)',
  cursor: 'pointer',
  background: 'linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(124,58,237,0.9) 40%, rgba(79,70,229,1) 100%)',
  color: '#fff',
  fontSize: '16px',
  fontWeight: 700,
  boxShadow: '0 1px 0 rgba(255,255,255,0.25) inset, 0 -1px 0 rgba(0,0,0,0.3) inset, 0 8px 32px rgba(124,58,237,0.45)',
  transition: 'all 0.2s',
...
const glossyBtnSmall: React.CSSProperties = {
  ...glossyBtn,
  padding: '10px 20px',
  fontSize: '13px',
  borderRadius: '8px',
...
const MODULES = [
  ...
  { num: '02', title: 'Anatomie d\'une vidéo satisfaisante qui convertit', desc: 'Hook 2s · contexte 3s · résolution 15s · CTA 2s. Structure exacte.' },
    ...
    <div style={{ background: '#080810', color: '#e8e8f0', overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <button onClick={handleCheckout} style={glossyBtnSmall}>67€ →</button>
        </div>
      </nav>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '780px' }}>
          ...
          <div style={{
            ...
            marginBottom: '2rem', animation: 'slideUp 0.6s ease both',
          }}>
            <span style={{
              width: '6px', height: '6px', borderRadius: '50%',
              background: '#4ade80', animation: 'pulse 2s ease infinite', display: 'inline-block',
            }} />
            <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.7)', fontFamily: 'monospace', letterSpacing: '0.08em' }}>
              Formation Google UAC · Indie Devs · Early bird 67€
            </span>
          </div>
          ...
          <h1 style={{
            ...
            <span style={{ display: 'block', color: '#ffffff', textShadow: titleShadow }}>
              Obtenez vos installs Android
            </span>
            <span style={{
              display: 'block',
              ...
              textShadow: 'none', filter: 'drop-shadow(0 0 20px rgba(124,58,237,0.6))',
            }}>
              à moins d'1€
            </span>
            <span style={{ display: 'block', color: '#ffffff', textShadow: titleShadow }}>
          ...
          <p style={{
            ...
            maxWidth: '560px', margin: '0 auto 3rem', lineHeight: 1.7,
            animation: 'slideUp 0.6s ease 0.2s both',
          }}>
            La méthode exacte issue de mes vraies campagnes. Pas de théorie — des chiffres réels,
            une structure précise, reproductible sur n'importe quelle app.
          </p>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                background: i === 0
                  ? 'linear-gradient(180deg, rgba(167,139,250,0.15) 0%, rgba(124,58,237,0.08) 100%)'
                  : 'rgba(255,255,255,0.03)',
                border: `1px solid ${i === 0 ? 'rgba(167,139,250,0.3)' : 'rgba(255,255,255,0.06)'}`,
                borderRadius: i === 0 ? '12px 0 0 12px' : i === 2 ? '0 12px 12px 0' : '0',
                minWidth: '160px',
                boxShadow: i === 0 ? '0 1px 0 rgba(255,255,255,0.1) inset' : 'none',
              }}>
                <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', animation: 'slideUp 0.6s ease 0.4s both' }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px', marginBottom: '4px' }}>
              <span style={{ fontSize: '44px', fontWeight: 800, color: '#fff', textShadow: '0 0 20px rgba(255,255,255,0.2)' }}>67€</span>
            ...
            <button
              ...
              onMouseEnter={e => {
                ...
                el.style.boxShadow = '0 1px 0 rgba(255,255,255,0.25) inset, 0 -1px 0 rgba(0,0,0,0.3) inset, 0 12px 40px rgba(124,58,237,0.6)'
              }}
              onMouseLeave={e => {
                const el = e.currentTarget
                el.style.transform = 'translateY(0)'
                el.style.boxShadow = '0 1px 0 rgba(255,255,255,0.25) inset, 0 -1px 0 rgba(0,0,0,0.3) inset, 0 8px 32px rgba(124,58,237,0.45)'
              }}
            >
      ...
      <section style={{ padding: '7rem 2rem', maxWidth: '780px', margin: '0 auto' }}>
        <AnimatedSection>
          ...
          <h2 style={{ fontSize: 'clamp(28px,4vw,46px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '1rem', textShadow: sectionTitleShadow }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
          {[
            ...
            <AnimatedSection key={i} delay={i * 60}>
              <div style={{
                padding: '1.5rem', borderRadius: '12px', height: '100%',
                background: c.bad
                  ? 'rgba(239,68,68,0.05)'
                  : 'linear-gradient(180deg, rgba(167,139,250,0.12) 0%, rgba(124,58,237,0.06) 100%)',
                border: `1px solid ${c.bad ? 'rgba(239,68,68,0.15)' : 'rgba(124,58,237,0.25)'}`,
                boxShadow: c.bad ? 'none' : '0 1px 0 rgba(255,255,255,0.08) inset',
              }}>
      ...
      <section style={{ padding: '7rem 2rem', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: '780px', margin: '0 auto' }}>
          <AnimatedSection>
            ...
            <h2 style={{ fontSize: 'clamp(28px,4vw,46px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '0.75rem', textShadow: sectionTitleShadow }}>
              ...
              <AnimatedSection key={i} delay={i * 40}>
                <div style={{
                  ...
                  onMouseEnter={e => {
                    ...
                    el.style.background = 'linear-gradient(180deg, rgba(167,139,250,0.1) 0%, rgba(124,58,237,0.05) 100%)'
                    el.style.borderColor = 'rgba(124,58,237,0.25)'
                    el.style.boxShadow = '0 1px 0 rgba(255,255,255,0.07) inset'
                  }}
                  onMouseLeave={e => {
                    const el = e.currentTarget as HTMLDivElement
      ...
      <section id="acheter" style={{ padding: '7rem 2rem', maxWidth: '780px', margin: '0 auto' }}>
        <AnimatedSection>
          ...
          <h2 style={{ fontSize: 'clamp(28px,4vw,46px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '3rem', textShadow: sectionTitleShadow }}>
        ...
        <AnimatedSection>
          <div style={{
            ...
            background: 'linear-gradient(180deg, rgba(167,139,250,0.1) 0%, rgba(79,70,229,0.06) 100%)',
            boxShadow: '0 1px 0 rgba(255,255,255,0.1) inset, 0 -1px 0 rgba(0,0,0,0.2) inset',
            marginBottom: '16px',
          }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '2rem' }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', gap: '10px', fontSize: '14px' }}>
                  <span style={{ color: '#a78bfa', fontWeight: 700, flexShrink: 0, filter: 'drop-shadow(0 0 6px rgba(167,139,250,0.6))' }}>✓</span>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px', marginBottom: '6px' }}>
                <span style={{ fontSize: '48px', fontWeight: 800, color: '#fff', textShadow: '0 0 20px rgba(255,255,255,0.15)' }}>67€</span>
                <span style={{ fontSize: '22px', color: 'rgba(255,255,255,0.3)', textDecoration: 'line-through' }}>97€</span>
              ...
              <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.25)', fontFamily: 'monospace', marginBottom: '1.5rem' }}>
                Prix augmente à 97€ au premier palier de ventes.
              </p>
              <button
                onClick={handleCheckout}
                style={{ ...glossyBtn, width: '100%', justifyContent: 'center', display: 'flex', alignItems: 'center' }}
                onMouseEnter={e => {
                  const el = e.currentTarget
                  el.style.transform = 'translateY(-2px)'
                  el.style.boxShadow = '0 1px 0 rgba(255,255,255,0.25) inset, 0 -1px 0 rgba(0,0,0,0.3) inset, 0 12px 40px rgba(124,58,237,0.6)'
      ...
      <section style={{ padding: '7rem 2rem', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto' }}>
          <AnimatedSection>
            ...
            <h2 style={{ fontSize: 'clamp(28px,4vw,42px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '2.5rem', textShadow: sectionTitleShadow }}>
              Avant d'acheter
            </h2>
          </AnimatedSection>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            {FAQS.map((f, i) => (
              <AnimatedSection key={i} delay={i * 50}>
                <div
                  ...
                  style={{
                    padding: '1.25rem 1.5rem', borderRadius: '10px', cursor: 'pointer',
                    border: '1px solid rgba(255,255,255,0.06)',
                    background: openFaq === i
                      ? 'linear-gradient(180deg, rgba(167,139,250,0.1) 0%, rgba(124,58,237,0.05) 100%)'
                      : 'rgba(255,255,255,0.02)',
                    boxShadow: openFaq === i ? '0 1px 0 rgba(255,255,255,0.07) inset' : 'none',
                    transition: 'all 0.2s',
                  }}
                >
      ...
      <section style={{ padding: '8rem 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <AnimatedSection>
            <h2 style={{ fontSize: 'clamp(32px,5vw,56px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '1rem', textShadow: titleShadow }}>
            ...
            <button
              onClick={handleCheckout}
              style={{ ...glossyBtn, fontSize: '17px', padding: '18px 48px' }}
              onMouseEnter={e => {
                const el = e.currentTarget
                el.style.transform = 'translateY(-2px)'
                el.style.boxShadow = '0 1px 0 rgba(255,255,255,0.25) inset, 0 -1px 0 rgba(0,0,0,0.3) inset, 0 12px 40px rgba(124,58,237,0.6)'
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '20px', fontWeight: 800, textShadow: '0 0 15px rgba(255,255,255,0.1)' }}>
            67€{' '}
            <span style={{ fontSize: '14px', color: 'rgba(255,255,255,0.25)', textDecoration: 'line-through', fontWeight: 400 }}>97€</span>
          </div>
          <div style={{ fontFamily: 'monospace', fontSize: '10px', color: 'rgba(255,255,255,0.3)' }}>Early bird · accès à vie · garanti 30j</div>
        </div>
        <button onClick={handleCheckout} style={glossyBtnSmall}>Accéder →</button>
      </div>
    </div>
  )
}
